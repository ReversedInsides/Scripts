...
---------------------------------
--Beautified by Sugarie Saffron--
---------------------------------
pcall(function(...) 
	local todelete = script.Parent:FindFirstChild("Tilt_Server") 
	if todelete then
		todelete:Destroy()
	end
	local todelete = script.Parent:FindFirstChild("HeadHandler") 
	if todelete then
		todelete:Destroy()
	end
	local todelete = script.Parent:FindFirstChild("Tilt") 
	if todelete then
		todelete:Destroy()
	end
	local todelete = script.Parent:FindFirstChild("HeadHandler_Server") 
	if todelete then
		todelete:Destroy()
	end
end)
...
for i, v in pairs(Player.Character:GetDescendants()) do
	if v:IsA("Shirt") or v:IsA("CharacterMesh") or v:IsA("Accessory") or v:IsA("Pants") or v:IsA("ShirtGraphic") or v.Name == "Chest" or v.Name == "FakeHeadM" or v:IsA("BodyColors") or v.Name == "FaysG" then
		v:Destroy()
...
Instance.new("BoolValue",Character).Name = "HolyMode"
...
--if v:IsA("BasePart") then v.BrickColor = BrickColor.new("Institutional white") end
--end
--end
--end))

local bcols = Instance.new("BodyColors",Character)
bcols.LeftArmColor = BrickColor.new("Institutional white")
bcols.RightArmColor = BrickColor.new("Institutional white")
bcols.LeftLegColor = BrickColor.new("Institutional white")
bcols.RightLegColor = BrickColor.new("Institutional white")
bcols.HeadColor = BrickColor.new("Institutional white")
bcols.TorsoColor = BrickColor.new("Institutional white")

Head.Transparency = 1
LACM = New("CharacterMesh",Character,"LACM",{MeshId = "279174949",BodyPart = "LeftArm"})
LLCM = New("CharacterMesh",Character,"LLCM",{MeshId = "319336109",BodyPart = "LeftLeg"})
RACM = New("CharacterMesh",Character,"RACM",{MeshId = "279174886",BodyPart = "RightArm"})
RLCM = New("CharacterMesh",Character,"RLCM",{MeshId = "319336155",BodyPart = "RightLeg"})
TOCM = New("CharacterMesh",Character,"TOCM",{MeshId = "376169183",BodyPart = "Torso"})
Pants = New("Pants",Character,"Pantsa",{PantsTemplate = "rbxassetid://389479482"})
Shirt = New("Shirt",Character,"Shirta",{ShirtTemplate = "rbxassetid://390381061"})
ChestStuff = New("Model",Character,"ChestStuff",{})
Collar = New("Part",ChestStuff,"Collar",{FormFactor = Enum.FormFactor.Custom,Size = Vector3.new(2, 1, 1),CFrame = CFrame.new(-1.70064068, 4.29996586, -16.7994385, 2.99409203e-06, 5.6751992e-10, -1, 1.17999421e-11, 0.999990225, 5.67524916e-10, 1, -1.18015302e-11, 2.99409203e-06),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,})
Mesh = New("SpecialMesh",Collar,"Mesh",{Scale = Vector3.new(1.10000002, 1, 1),MeshId = "http://www.roblox.com/asset/?id=63717022",TextureId = "http://www.roblox.com/asset/?id=133861532 ",MeshType = Enum.MeshType.FileMesh,})
Weld = New("ManualWeld",Collar,"Weld",{Part0 = Collar,Part1 = Torso,C0 = CFrame.new(0, 0, 0, 1.29482317e-19, -2.25178137e-22, 1, 2.80755899e-22, 1, 2.25178137e-22, -1, 2.80755899e-22, 1.29482317e-19),C1 = CFrame.new(2.38418579e-07, 1.29998374, 0.499998093, 4.49431016e-21, 4.7225172e-22, 1, -6.79971797e-22, 0.999996424, -4.72250306e-22, -1, -6.79974725e-22, 4.49431016e-21),})
Cape = New("Part",ChestStuff,"Cape",{FormFactor = Enum.FormFactor.Custom,Size = Vector3.new(1, 1, 0.200000003),CFrame = CFrame.new(-2.89767838, 2.38060069, -16.7990494, -2.52780637e-06, -0.642786622, -0.766044497, -2.34805711e-07, -0.766036451, 0.642780483, -0.999999464, 2.04442836e-06, 2.80171844e-06),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,})
Mesh = New("SpecialMesh",Cape,"Mesh",{Scale = Vector3.new(2, 2.5, 0.5),MeshId = "http://www.roblox.com/asset/?id=63717022",TextureId = "http://www.roblox.com/asset/?id=64110954",MeshType = Enum.MeshType.FileMesh,})
Weld = New("ManualWeld",Cape,"Weld",{Part0 = Cape,Part1 = Torso,C0 = CFrame.new(0, 0, 0, 4.66283979e-07, -2.34796204e-07, -0.999999464, -0.642786622, -0.766043961, 1.19856935e-07, -0.766044497, 0.642786801, 5.08118433e-07),C1 = CFrame.new(0.000385522842, -0.61939311, 1.69703579, 4.49431016e-21, 4.7225172e-22, 1, -6.79971797e-22, 0.999996424, -4.72250306e-22, -1, -6.79974725e-22, 4.49431016e-21),})
TailPart = New("Part",ChestStuff,"TailPart",{BrickColor = BrickColor.new("Institutional white"),FormFactor = Enum.FormFactor.Custom,Size = Vector3.new(0.200000003, 0.200000003, 0.200000003),CFrame = CFrame.new(-1.68723869, 2.17991281, -16.8110466, -0.866020024, 4.27408349e-06, -0.500009298, 0.433020443, 0.49998793, -0.749990582, 0.249997839, -0.866029561, -0.433005661),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,Color = Color3.new(0.972549, 0.972549, 0.972549),})
Mesh = New("SpecialMesh",TailPart,"Mesh",{Scale = Vector3.new(0.200000003, 0.200000003, 0.200000003),MeshId = "http://www.roblox.com/asset/?id=188635159",MeshType = Enum.MeshType.FileMesh,})
Weld = New("ManualWeld",TailPart,"Weld",{Part0 = TailPart,Part1 = Torso,C0 = CFrame.new(0, 0, 0, -0.866020799, 0.433024675, 0.249995247, 6.86677186e-06, 0.499992818, -0.866029561, -0.500007987, -0.749997914, -0.433007151),C1 = CFrame.new(-0.0116074085, -0.820082188, 0.486596107, 4.49431016e-21, 4.7225172e-22, 1, -6.79971797e-22, 0.999996424, -4.72250306e-22, -1, -6.79974725e-22, 4.49431016e-21),})
Pads = New("Part",ChestStuff,"Pads",{FormFactor = Enum.FormFactor.Symmetric,Size = Vector3.new(2, 1, 0.899999976),CFrame = CFrame.new(-1.3506422, 3.89997244, -16.7994385, 3.60440413e-06, 7.15832755e-07, -1, 2.93740754e-10, 0.999993801, 7.15828321e-07, 1, -2.96322522e-10, 3.60440413e-06),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,})
Mesh = New("SpecialMesh",Pads,"Mesh",{Scale = Vector3.new(2.20000005, 1.5, 2),MeshId = "http://www.roblox.com/asset/?id=340617875     ",TextureId = "http://www.roblox.com/asset/?id=340617950  ",MeshType = Enum.MeshType.FileMesh,})
Weld = New("ManualWeld",Pads,"Weld",{Part0 = Pads,Part1 = Torso,C0 = CFrame.new(0, 0, 0, 6.10310963e-07, 2.81943358e-10, 0.999998093, 7.15258068e-07, 0.999993563, -4.93400876e-10, -0.999997735, 1.19208619e-06, 6.10499455e-07),C1 = CFrame.new(1.84774399e-06, 0.899987936, 0.149999619, 4.49431016e-21, 4.7225172e-22, 1, -6.79971797e-22, 0.999996424, -4.72250306e-22, -1, -6.79974725e-22, 4.49431016e-21),})
HeadStuff = New("Model",Character,"HeadStuff",{})
FakeHead = New("Part",HeadStuff,"FakeHead",{BrickColor = BrickColor.new("Institutional white"),FormFactor = Enum.FormFactor.Symmetric,Size = Vector3.new(2, 1, 1),CFrame = CFrame.new(-1.20064259, 4.49998093, -16.7994404, 2.99409203e-06, 5.67521974e-10, -1, 1.17999421e-11, 0.999993801, 5.67524916e-10, 1, -1.18015727e-11, 2.99409203e-06),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,Color = Color3.new(0.972549, 0.972549, 0.972549),})
Mesh = New("SpecialMesh",FakeHead,"Mesh",{Scale = Vector3.new(1.25, 1.25, 1.25),})
Weld = New("ManualWeld",FakeHead,"Weld",{Part0 = FakeHead,Part1 = Head,C0 = CFrame.new(0, 0, 0, 4.49431016e-21, 4.72251821e-22, 1, -6.79974523e-22, 1, -4.72251821e-22, -1, -6.79974523e-22, 4.49431016e-21),C1 = CFrame.new(0, 0, 0, 4.49431016e-21, 4.72251821e-22, 1, -6.79974523e-22, 1, -4.72251821e-22, -1, -6.79974523e-22, 4.49431016e-21),})
Decal = New("Decal",FakeHead,"Decal",{Texture = "rbxassetid://1173606089",})
Part = New("Part",HeadStuff,"Part",{BrickColor = BrickColor.new("Institutional white"),FormFactor = Enum.FormFactor.Plate,Size = Vector3.new(0.600000024, 1, 0.600000024),CFrame = CFrame.new(-1.11440957, 4.48569775, -16.1841698, 0.939692736, -0.336824387, -0.0593881011, 0.3420178, 0.925411046, 0.163174689, -2.81353073e-06, -0.173646942, 0.984807968),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,Color = Color3.new(0.972549, 0.972549, 0.972549),})
Mesh = New("SpecialMesh",Part,"Mesh",{Scale = Vector3.new(0.400000006, 0.600000024, 0.400000006),MeshId = "http://www.roblox.com/asset/?id=1778999",MeshType = Enum.MeshType.FileMesh,})
...
Part = New("Part",HeadStuff,"Part",{BrickColor = BrickColor.new("Institutional white"),Material = Enum.Material.SmoothPlastic,Transparency = 1,Transparency = 1,Size = Vector3.new(0.399999857, 0.200000003, 0.800000012),CFrame = CFrame.new(-0.699055672, 5.08261108, -16.7994595, 2.99409203e-06, -0.173647985, -0.984807849, 1.17999421e-11, 0.984801769, -0.173646912, 1, 5.1990645e-07, 2.94860729e-06),CanCollide = false,BottomSurface = Enum.SurfaceType.Smooth,TopSurface = Enum.SurfaceType.Smooth,Color = Color3.new(0.972549, 0.972549, 0.972549),})
Mesh = New("SpecialMesh",Part,"Mesh",{MeshType = Enum.MeshType.Wedge,})
Weld = New("ManualWeld",Part,"Weld",{Part0 = Part,Part1 = FakeHead,C0 = CFrame.new(0, 0, 0, 0, -3.05623195e-42, 1, -0.173647985, 0.984807849, 0, -0.984807849, -0.173647985, 0),C1 = CFrame.new(-1.71661377e-05, 0.582633972, -0.501586914, 4.49431016e-21, 4.72251821e-22, 1, -6.79974523e-22, 1, -4.72251821e-22, -1, -6.79974523e-22, 4.49431016e-21),})
...
Mesh = New("SpecialMesh",Part,"Mesh",{MeshType = Enum.MeshType.Wedge,})
Weld = New("ManualWeld",Part,"Weld",{Part0 = Part,Part1 = FakeHead,C0 = CFrame.new(0, 0, 0, 0, -3.05623195e-42, 1, -0.499999851, 0.866026402, 0, -0.866026402, -0.499999851, 0),C1 = CFrame.new(-1.71661377e-05, 0.655839443, -0.228378296, 4.49431016e-21, 4.72251821e-22, 1, -6.79974523e-22, 1, -4.72251821e-22, -1, -6.79974523e-22, 4.49431016e-21),})
...
coroutine.resume(coroutine.create(function()
	while true do
		swait()
		if moosiks.IsPlaying == true then
			if speeddep == true then
				Skybox.CFrame = Skybox.CFrame * CFrame.fromEulerAnglesXYZ(0,math.rad(speed*(moosiks.PlaybackLoudness/500)),0)
				for i, v in pairs(MusicBars:GetChildren()) do
					v.CFrame = v.CFrame * CFrame.fromEulerAnglesXYZ(0,math.rad(-speed*(moosiks.PlaybackLoudness/500)),0)
					v.Mesh.Scale = Vector3.new(1000,(moosiks.PlaybackLoudness)*20,1000)
				end
			elseif speeddep == false then
				Skybox.CFrame = Skybox.CFrame * CFrame.fromEulerAnglesXYZ(0,math.rad(speed),0)
				for i, v in pairs(MusicBars:GetChildren()) do
					v.CFrame = v.CFrame * CFrame.fromEulerAnglesXYZ(0,math.rad(-speed),0)
					v.Mesh.Scale = Vector3.new(1000,(moosiks.PlaybackLoudness)*20,1000)
				end
			end
		end
...
AesthPart = function(model, wldpar, reflec, trans, col, name, neon, meshh, mshtype, mshtxt, x1, y1, z1, ceef)
	prt = part(3, model, reflec, trans, BrickColor.new(col), name, vt(.2,.2,.2))
	prt.Material = neon
...
handle = part(3, handles, 0, 1, BrickColor.new(NewCol), "Handle", vt(.2,.2,.2))
local handle2 = part(3, handles, 0, 1, BrickColor.new(NewCol), "Handle2", vt(.2,.2,.2))
local handle3 = part(3, handles, 0, 1, BrickColor.new(NewCol3), "Handle3", vt(.2,.2,.2))
local handle3a = part(3, handles, 0, 1, BrickColor.new(NewCol3), "Handle3a", vt(.2,.2,.2))
local handle4 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle4", vt(.2,.2,.2))
local handle5 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle5", vt(.2,.2,.2))
local handle6 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle6", vt(.2,.2,.2))
local handle7 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle7", vt(.2,.2,.2))
local handle8 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle8", vt(.2,.2,.2))
local handle9 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle9", vt(.2,.2,.2))
local handle10 = part(3, model2, 0, 1, BrickColor.new(NewCol3), "Handle10", vt(.2,.2,.2))
...
local hitbox = part(3, nil, 0, 1, BrickColor.new("Black"), "Hitbox", vt(.2,.2,.2))
...
attackfour = function()
	...
	if Stagger.Value ~= true and StunT.Value > Stun.Value then
		...
		if Stagger.Value ~= true and StunT.Value > Stun.Value then
			...
			hitbox.Parent = nil
			local ref1 = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
			ref1.Anchored = true
			ref1.CFrame = cf(main1.Position)
			game:GetService("Debris"):AddItem(ref1, 1)
			so("341336243", ref1, 1, 1)
			local ref2 = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
			ref2.Anchored = true
...
PowerRising = function()
	...
	cooldownsadd[3] = 0.14
	prising = true
	local prref = part(3, nil, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
	prref.Anchored = true
...
Star = function(mainpart, rand)
	local stref = part(3, effects, 0, 0, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
	stref.Anchored = true
	stref.Material = "Neon"
...
do1 = function()
	...
	if cooldowns[1] >= 50 then
		...
		cdebounce = false
		local dashoot = 0
		local laser1 = part(3, nil, 0, 0.5, BrickColor.new("Really red"), "Effect", vt(.2,.2,.2))
		...
		while cbuster == true and cooldowns[1] > 10 do
			...
			if busterlaser == true then
				...
				local refl = part(3, nil, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
				refl.Anchored = true
				for d = 1, 7 do
					for i = 0, 1, 0.25 do
						swait()
...
do2 = function()
	...
	if cooldowns[2] >= 70 then
		...
		so("341336144", RightArm, 1, 1)
		sbreaker = true
		local sbref1 = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
		local sbrwld1 = weld(sbref1, sbref1, LeftArm, cf(0, 1, 0))
		local sbref2 = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
		...
		shockdebounce = false
		local dashoot = 3
		local sref = part(3, nil, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
		sref.Anchored = true
		TehM = nil
		while sbreaker == true and cooldowns[2] > 20 do
			...
			if sbreakerII == true then
				...
				for i = 1, 3 do
					...
					local d1 = part(3, effects, 0, 0.5, BrickColor.new("White"), "Effect", vt(.2,.2,.2))
					d1.Anchored = true
					d1.CFrame = cf(pos2)
					d1.Material = "Neon"
...
do3 = function()
	...
	if cooldowns[3] >= 80 then
		...
		stardebounce = false
		local dashoot = 0
		local sref = part(3, nil, 0, 0.5, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
		sref.Anchored = true
		TehM = nil
...
DecreaseStat = function(Model, Stat, Amount, Duration)
	if Model:findFirstChild("Stats") ~= nil and Model.Stats[Stat] ~= nil then
		...
		if Model:findFirstChild("Head") ~= nil then
			display = ""
			if Stat == "Damage" then
				if Amount > 0 then
					display = "-Damage"
				...
				if d.className == "Model" and ranged ~= true then
					...
					if head ~= nil then
						...
						if mag <= magni and c.Name ~= Player.Name then
							ref = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
							ref.Anchored = true
...
MagicBlock = function(brickcolor, cframe, x1, y1, z1, x3, y3, z3, delay, Type)
	local prt = part(3, effects, 0, 0, brickcolor, "Effect", vt(.2,.2,.2))
	prt.Anchored = true
	prt.CFrame = cframe
...
ClangEffect = function(brickcolor, cframe, duration, decrease, size, power)
	local prt = part(3, effects, 0, 1, brickcolor, "Effect", vt(.2,.2,.2))
	prt.Anchored = true
	prt.CFrame = cframe
					...
					if Thing ~= nil then
						...
						if Thing[2] == "SatelliteStrike" then
							if Thing[5] < 100 then
								...
								refda = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
								refda.Anchored = true
									...
									do
										if Thing[2] == "Shoot3" then
											...
											if Thing[3] <= 0 then
												...
												local staaaaref = part(3, effects, 0, 1, BrickColor.new("Black"), "Reference", vt(.2,.2,.2))
